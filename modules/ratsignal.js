...
function ratsignal(args, bot, msg)
{
...
function getRatsignalContactRole(args, bot, msg)
{
	var ratsignalContactRole = botFunctions.getConfigValue(msg.server, "RATSIGNAL_CONTACT_ROLE");
...
function setRatsignalContactRole(args, bot, msg)
{
...
function getRatsignalEmergencyChannel(args, bot, msg)
{
	var ratsignalEmergencyChannel = botFunctions.getConfigValue(msg.server, "RATSIGNAL_EMERGENCY_CHANNEL");
...
function setRatsignalEmergencyChannel(args, bot, msg)
{
...
function getRatsignalFuelProcedureLink(args, bot, msg)
{
	var ratsignalFuelProcedureLink = botFunctions.getConfigValue(msg.server, "RATSIGNAL_FUEL_PROCEDURE_LINK");
...
function setRatsignalFuelProcedureLink(args, bot, msg)
{
...
var commands = {
	...
	"getRatsignalContactRole": {
		...
		process: getRatsignalContactRole,
		permissions: [
			"administrator"
		]
	},
	"setRatsignalContactRole": {
		...
		process: setRatsignalContactRole,
		permissions: [
			"administrator"
		]
	},
	"getRatsignalEmergencyChannel": {
		...
		process: getRatsignalEmergencyChannel,
		permissions: [
			"administrator"
		]
	},
	"setRatsignalEmergencyChannel": {
		...
		process: setRatsignalEmergencyChannel,
		permissions: [
			"administrator"
		]
	},
	"getRatsignalFuelProcedureLink": {
		...
		process: getRatsignalFuelProcedureLink,
		permissions: [
			"administrator"
		]
	},
	"setRatsignalFuelProcedureLink": {
		...
		process: setRatsignalFuelProcedureLink,
		permissions: [
			"administrator"
		]
	},
