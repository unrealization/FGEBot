...
function security(args, bot, msg)
{
...
function getSecurityContactRole(args, bot, msg)
{
	var securityContactRole = botFunctions.getConfigValue(msg.server, "SECURITY_CONTACT_ROLE");
...
function setSecurityContactRole(args, bot, msg)
{
...
function getSecurityEmergencyChannel(args, bot, msg)
{
	var securityEmergencyChannel = botFunctions.getConfigValue(msg.server, "SECURITY_EMERGENCY_CHANNEL");
...
function setSecurityEmergencyChannel(args, bot, msg)
{
...
function getSecurityEmergencyProcedureLink(args, bot, msg)
{
...
function setSecurityEmergencyProcedureLink(args, bot, msg)
{
...
var commands = {
	...
	"getSecurityContactRole": {
		...
		process: getSecurityContactRole,
		permissions: [
			"administrator"
		]
	},
	"setSecurityContactRole": {
		...
		process: setSecurityContactRole,
		permissions: [
			"administrator"
		]
	},
	"getSecurityEmergencyChannel": {
		...
		process: getSecurityEmergencyChannel,
		permissions: [
			"administrator"
		]
	},
	"setSecurityEmergencyChannel": {
	/*"getSecurityEmergencyProcedureLink": {
		help: "Get the current security emergency procedure link.",
		process: getSecurityEmergencyProcedureLink,
		permissions: [
			"administrator"
		]
	},*/
	/*"setSecurityEmergencyProcedureLink": {
		usage: "[link]",
		help: "Sets a link, or none, as the link commanders will be sent for security emergency procedures in case of a security signal.",
		process: setSecurityEmergencyProcedureLink,
		permissions: [
			"administrator
		]
	},*/
		...
		process: setSecurityEmergencyChannel,
		permissions: [
			"administrator"
		]
	},
